...
## 链接
url_shell=${JD_SHELL_URL:-https://gitee.com/wuyouio/base.git}
url_scripts=${JD_SCRIPTS_URL:-https://gitee.com/wuyouio/cripts.git}
...
"
    ...
    url_scripts=${JD_SCRIPTS_URL:-https://gitee.com/wuyouio/scripts.git}
